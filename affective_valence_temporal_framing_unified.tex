...
($0.25$ vs $0.46$), forward-framing dominance (ABSTRACT, the low-cost prospection
operator, taken on $79\%$ of steps), and strongly negative reward valence
($-0.42$ vs $+0.10$ healthy) from \emph{frustrated forward projection}: abstract
prospection commits to above-neutral predictions that a volatile world falsifies
(Figure~\ref{fig:stress}). At the mood timescale, the
